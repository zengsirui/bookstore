...
<html>
 ...
 <div class="rt_content" id="sproductContainer">
      <div class="page_title">
       <h2 class="fl">商品列表示例</h2>
        <a href="product_list.jsp" class="fr top_rt_btn add_icon">返回列表</a>
	...
	<script type="text/javascript">
		...
		methods:{
			...
			this.$http.post("getProductByName", params,{emulateJSON:true}).then(
				function(res){
