...
<html>
 ...
 <div class="rt_content" id="plistContainer">
	...
	<script type="text/javascript">
		...
		methods:{
			pageHandler:function(page){
				...
				this.$http.post("getUsersByName", params,{emulateJSON:true}).then(
					function(res){
			...
			insert:function(){
				var params = {"username":this.username,"userid":this.selected};
				this.$http.post("insertUsers",params,{emulateJSON:true}).then(
				function(res){
					alert("添加成功！");
					window.location.reload(true);
				},
